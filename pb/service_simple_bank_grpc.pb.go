...
const (
	...
	SimpleBank_SigninUser_FullMethodName = "/pb.SimpleBank/SigninUser"
)
...
type SimpleBankClient interface {
	...
	SigninUser(ctx context.Context, in *CreateSigninRequest, opts ...grpc.CallOption) (*CreateSigninResponse, error)
}
...
func (c *simpleBankClient) SigninUser(ctx context.Context, in *CreateSigninRequest, opts ...grpc.CallOption) (*CreateSigninResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateSigninResponse)
	err := c.cc.Invoke(ctx, SimpleBank_SigninUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleBankServer interface {
	...
	SigninUser(context.Context, *CreateSigninRequest) (*CreateSigninResponse, error)
...
func (UnimplementedSimpleBankServer) SigninUser(context.Context, *CreateSigninRequest) (*CreateSigninResponse, error) {
...
func _SimpleBank_SigninUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimpleBank_SigninUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).SigninUser(ctx, req.(*CreateSigninRequest))
	}
	return interceptor(ctx, in, info, handler)
}
